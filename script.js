document.addEventListener("DOMContentLoaded", function () {
  ...
  //   if (!e.target.closest("#form-btn")) return;
  ...
  document.querySelector("form").onsubmit = function () {
    ...
    .then((data) => {
      ...
      sunsetTime.innerHTML = `Sunset: ${data.daily.sunset[0].slice(11, 16)}`;

      // sunrise time
      const sunriseTime = document.querySelector("#sunrise-time");
      sunriseTime.innerHTML = `Sunrise: ${data.daily.sunrise[0].slice(11, 16)}`;
